...
#define MANUAL_MODE_CMD_MASK	0x0020
#define AUTO_MODE_CMD_MASK		0x0040
#define WALL_SENSOR_MASK		0x0080
#define LEFT_SENSOR_MASK		0x0100
#define RIGHT_SENSOR_MASK		0x0200